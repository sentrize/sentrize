...
export default function Page() {
  return (
    <>
      ...
      <div className="page-wrapper" nav-theme="light">
                ...
                <div className="v2-footer-grid">
                  ...
                  <div className="v2-footer-col">
                    ...
                    <div className="v2-footer-form-block w-form">
                      <form action="#" aria-label="footer_form" className="v2-footer-form" data-name="footer_form" data-wf-element-id="606ebe6c-e56a-68eb-635f-3431f4bf7c7e" data-wf-page-id="685598a75e32265c30b93bfa" id="wf-form-footer_form" method="post" name="wf-form-footer_form">
