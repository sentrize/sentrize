    ...
    <>
      ...
      <main className="main-wrapper">
        <section className="home_hero-section is-homepage-v3" data-section-hero="true">
          <img alt="" className="home_new-image is-einstein" data-image="einstein" data-image-einstein-anim="true" loading="lazy" src="/assets/images/hero/cloud-main.svg" />
          ...
          <img alt="" className="home_new-image is-newton" data-image="newton" data-image-newton-anim-main="true" loading="lazy" src="/assets/images/hero/mesh-main.svg" />
          <img alt="" className="home_new-image is-franklin" data-image="franklin" data-image-franklin-anim-main="true" loading="lazy" src="/assets/images/hero/orbit-main.svg" />
          <img alt="" className="home_new-image-right is-einstein" data-image="einstein" data-image-einstein-anim-main="true" loading="lazy" src="/assets/images/hero/cloud-accent.svg" />
          <img alt="" className="home_new-image-right is-newton" data-image="newton" data-image-newton-anim="true" loading="lazy" src="/assets/images/hero/mesh-accent.svg" />
          <img alt="" className="home_new-image-right is-franklin" data-image="franklin" data-image-franklin-anim="true" loading="lazy" src="/assets/images/hero/orbit-accent.svg" />
                  ...
                  <a aria-label="Software" className="aadl_node w-button is-active" data-i="0" data-wf-ao-click-engagement-tracking="true" data-wf-component-context="%5B%7B%22componentId%22%3A%223405ee4e-7a32-0157-66cc-3f9eb8e587ce%22%2C%22instanceId%22%3A%2288a794d7-9da4-2b63-566a-91eab1c458de%22%7D%5D" data-wf-element-id="3405ee4e-7a32-0157-66cc-3f9eb8e587e6" data-wf-native-id-path="88a794d7-9da4-2b63-566a-91eab1c458de:3405ee4e-7a32-0157-66cc-3f9eb8e587e6" href="#">
                    <div className="aadl_pill">
                      <div className="aadl_ico">
                        <svg aria-hidden="true" fill="none" viewBox="0 0 20 20"><path d="M6 13.6 C3.4 13.6 1.8 11.95 1.8 10 C1.8 8.05 3.4 6.4 6 6.4 C8.1 6.4 9.2 8 10 10 C10.8 12 11.9 13.6 14 13.6 C16.6 13.6 18.2 11.95 18.2 10 C18.2 8.05 16.6 6.4 14 6.4 C11.9 6.4 10.8 8 10 10 C9.2 12 8.1 13.6 6 13.6" stroke="#7FC8FF" strokeWidth="1.7" strokeLinecap="round" fill="none" /><path d="M16.4 5.2 L18.2 6.4 L16.7 7.9" stroke="#7FC8FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" /><path d="M3.6 14.8 L1.8 13.6 L3.3 12.1" stroke="#7FC8FF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" /></svg>
                      </div>
